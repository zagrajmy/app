...
export type ValueTypes = {
  ["guild"]: AliasType<{
    ...
    guild_members?: [
      {
        distinct_on?: ValueTypes["guild_member_select_column"][];
        limit?: number;
        offset?: number;
        order_by?: ValueTypes["guild_member_order_by"][];
        where?: ValueTypes["guild_member_bool_exp"];
      },
      ValueTypes["guild_member"]
    ];
    guild_members_aggregate?: [
      ...
      ValueTypes["guild_member_aggregate"]
    ];
    id?: true;
    meetings?: [
      {
        distinct_on?: ValueTypes["meeting_select_column"][];
        limit?: number;
        offset?: number;
        order_by?: ValueTypes["meeting_order_by"][];
  ...
  ["guild_aggregate_fields"]: AliasType<{
    ...
    count?: [
      { columns?: ValueTypes["guild_select_column"][]; distinct?: boolean },
      true
    ];
  ...
  ["guild_member_aggregate_fields"]: AliasType<{
    ...
    count?: [
      {
        columns?: ValueTypes["guild_member_select_column"][];
        distinct?: boolean;
      },
      true
    ];
  ...
  ["meeting"]: AliasType<{
    ...
    participants?: [
      {
        distinct_on?: ValueTypes["meeting_participant_select_column"][];
        limit?: number;
        offset?: number;
        order_by?: ValueTypes["meeting_participant_order_by"][];
        where?: ValueTypes["meeting_participant_bool_exp"];
      },
      ValueTypes["meeting_participant"]
    ];
    participants_aggregate?: [
      ...
      ValueTypes["meeting_participant_aggregate"]
    ];
  ...
  ["meeting_aggregate_fields"]: AliasType<{
    ...
    count?: [
      { columns?: ValueTypes["meeting_select_column"][]; distinct?: boolean },
      true
    ];
  ...
  ["meeting_delete_at_path_input"]: {
    image?: (string | undefined)[];
  };
  ["meeting_delete_elem_input"]: {
    image?: number;
  };
  ["meeting_delete_key_input"]: {
    image?: string;
  };
  ["meeting_inc_input"]: {
    guild_id?: number;
  ...
  ["meeting_participant_aggregate_fields"]: AliasType<{
    ...
    count?: [
      {
        columns?: ValueTypes["meeting_participant_select_column"][];
        distinct?: boolean;
      },
      true
    ];
  ...
  ["mutation_root"]: AliasType<{
    delete_guild?: [
      { where: ValueTypes["guild_bool_exp"] },
      ValueTypes["guild_mutation_response"]
    ];
    delete_guild_by_pk?: [{ id: number }, ValueTypes["guild"]];
    delete_guild_member?: [
      { where: ValueTypes["guild_member_bool_exp"] },
      ValueTypes["guild_member_mutation_response"]
    ];
    delete_guild_member_by_pk?: [
      { guild_id: number; member_id: ValueTypes["uuid"] },
      ValueTypes["guild_member"]
    ];
    delete_meeting?: [
      { where: ValueTypes["meeting_bool_exp"] },
      ValueTypes["meeting_mutation_response"]
    ];
    delete_meeting_by_pk?: [{ id: number }, ValueTypes["meeting"]];
    delete_meeting_participant?: [
      { where: ValueTypes["meeting_participant_bool_exp"] },
      ValueTypes["meeting_participant_mutation_response"]
    ];
    delete_meeting_participant_by_pk?: [
      { meeting_id: number; participant_id: ValueTypes["uuid"] },
      ValueTypes["meeting_participant"]
    ];
    delete_sphere?: [
      { where: ValueTypes["sphere_bool_exp"] },
      ValueTypes["sphere_mutation_response"]
    ];
    ...
    insert_guild?: [
      {
        objects: ValueTypes["guild_insert_input"][];
        on_conflict?: ValueTypes["guild_on_conflict"];
      },
      ValueTypes["guild_mutation_response"]
    ];
    insert_guild_member?: [
      {
        objects: ValueTypes["guild_member_insert_input"][];
        on_conflict?: ValueTypes["guild_member_on_conflict"];
      },
      ValueTypes["guild_member_mutation_response"]
    ];
    insert_guild_member_one?: [
      {
        object: ValueTypes["guild_member_insert_input"];
        on_conflict?: ValueTypes["guild_member_on_conflict"];
      },
      ValueTypes["guild_member"]
    ];
    insert_guild_one?: [
      {
        object: ValueTypes["guild_insert_input"];
        on_conflict?: ValueTypes["guild_on_conflict"];
      },
      ValueTypes["guild"]
    ];
    insert_meeting?: [
      {
        objects: ValueTypes["meeting_insert_input"][];
        on_conflict?: ValueTypes["meeting_on_conflict"];
      },
      ValueTypes["meeting_mutation_response"]
    ];
    insert_meeting_one?: [
      {
        object: ValueTypes["meeting_insert_input"];
        on_conflict?: ValueTypes["meeting_on_conflict"];
      },
      ValueTypes["meeting"]
    ];
    insert_meeting_participant?: [
      {
        objects: ValueTypes["meeting_participant_insert_input"][];
        on_conflict?: ValueTypes["meeting_participant_on_conflict"];
      },
      ValueTypes["meeting_participant_mutation_response"]
    ];
    insert_meeting_participant_one?: [
      {
        object: ValueTypes["meeting_participant_insert_input"];
        on_conflict?: ValueTypes["meeting_participant_on_conflict"];
      },
      ValueTypes["meeting_participant"]
    ];
    insert_sphere?: [
      {
        objects: ValueTypes["sphere_insert_input"][];
    ...
    insert_sphere_one?: [
      {
        object: ValueTypes["sphere_insert_input"];
        on_conflict?: ValueTypes["sphere_on_conflict"];
      },
      ValueTypes["sphere"]
    ];
    insert_user?: [
      {
        objects: ValueTypes["user_insert_input"][];
    ...
    insert_user_one?: [
      {
        object: ValueTypes["user_insert_input"];
        on_conflict?: ValueTypes["user_on_conflict"];
      },
      ValueTypes["user"]
    ];
    update_guild?: [
      {
        _inc?: ValueTypes["guild_inc_input"];
        _set?: ValueTypes["guild_set_input"];
        where: ValueTypes["guild_bool_exp"];
      },
      ValueTypes["guild_mutation_response"]
    ];
    update_guild_by_pk?: [
      {
        _inc?: ValueTypes["guild_inc_input"];
        _set?: ValueTypes["guild_set_input"];
        pk_columns: ValueTypes["guild_pk_columns_input"];
      },
      ValueTypes["guild"]
    ];
    update_guild_member?: [
      {
        _inc?: ValueTypes["guild_member_inc_input"];
        _set?: ValueTypes["guild_member_set_input"];
        where: ValueTypes["guild_member_bool_exp"];
      },
      ValueTypes["guild_member_mutation_response"]
    ];
    update_guild_member_by_pk?: [
      {
        _inc?: ValueTypes["guild_member_inc_input"];
        _set?: ValueTypes["guild_member_set_input"];
        pk_columns: ValueTypes["guild_member_pk_columns_input"];
      },
      ValueTypes["guild_member"]
    ];
    update_meeting?: [
      {
        _append?: ValueTypes["meeting_append_input"];
        _delete_at_path?: ValueTypes["meeting_delete_at_path_input"];
        _delete_elem?: ValueTypes["meeting_delete_elem_input"];
        _delete_key?: ValueTypes["meeting_delete_key_input"];
        _inc?: ValueTypes["meeting_inc_input"];
        _prepend?: ValueTypes["meeting_prepend_input"];
        _set?: ValueTypes["meeting_set_input"];
        where: ValueTypes["meeting_bool_exp"];
      },
      ValueTypes["meeting_mutation_response"]
    ];
    update_meeting_by_pk?: [
      {
        ...
        _prepend?: ValueTypes["meeting_prepend_input"];
        _set?: ValueTypes["meeting_set_input"];
        pk_columns: ValueTypes["meeting_pk_columns_input"];
      },
      ValueTypes["meeting"]
    ];
    update_meeting_participant?: [
      {
        _inc?: ValueTypes["meeting_participant_inc_input"];
        _set?: ValueTypes["meeting_participant_set_input"];
        where: ValueTypes["meeting_participant_bool_exp"];
      },
      ValueTypes["meeting_participant_mutation_response"]
    ];
    update_meeting_participant_by_pk?: [
      {
        _inc?: ValueTypes["meeting_participant_inc_input"];
        _set?: ValueTypes["meeting_participant_set_input"];
        pk_columns: ValueTypes["meeting_participant_pk_columns_input"];
      },
      ValueTypes["meeting_participant"]
    ];
    update_sphere?: [
      {
        _inc?: ValueTypes["sphere_inc_input"];
        _set?: ValueTypes["sphere_set_input"];
        where: ValueTypes["sphere_bool_exp"];
      },
      ValueTypes["sphere_mutation_response"]
    ];
    update_sphere_by_pk?: [
      {
        _inc?: ValueTypes["sphere_inc_input"];
        _set?: ValueTypes["sphere_set_input"];
        pk_columns: ValueTypes["sphere_pk_columns_input"];
      },
      ValueTypes["sphere"]
    ];
    update_user?: [
  ...
  ["query_root"]: AliasType<{
    guild?: [
      {
        distinct_on?: ValueTypes["guild_select_column"][];
        limit?: number;
        offset?: number;
        order_by?: ValueTypes["guild_order_by"][];
        where?: ValueTypes["guild_bool_exp"];
      },
      ValueTypes["guild"]
    ];
    ...
    sphere?: [
      {
        distinct_on?: ValueTypes["sphere_select_column"][];
        limit?: number;
        offset?: number;
        order_by?: ValueTypes["sphere_order_by"][];
        where?: ValueTypes["sphere_bool_exp"];
      },
      ValueTypes["sphere"]
    ];
    sphere_aggregate?: [
      ...
      ValueTypes["sphere_aggregate"]
    ];
    sphere_by_pk?: [{ id: number }, ValueTypes["sphere"]];
    user?: [
      {
        distinct_on?: ValueTypes["user_select_column"][];
        limit?: number;
        offset?: number;
        order_by?: ValueTypes["user_order_by"][];
        where?: ValueTypes["user_bool_exp"];
      },
      ValueTypes["user"]
    ];
  ...
  ["sphere_aggregate_fields"]: AliasType<{
    ...
    count?: [
      { columns?: ValueTypes["sphere_select_column"][]; distinct?: boolean },
      true
    ];
...
export type meeting_append_input = {
  image?: jsonb;
};
...
export type meeting_delete_at_path_input = {
  image?: (string | undefined)[];
};

export type meeting_delete_elem_input = {
  image?: number;
};

export type meeting_delete_key_input = {
  image?: string;
};
...
export type meeting_prepend_input = {
  image?: jsonb;
};
...
export const AllTypesProps: Record<string, any> = {
  ...
  mutation_root: {
    ...
    update_meeting: {
      _append: {
        type: "meeting_append_input",
        array: false,
        arrayRequired: false,
        required: false,
      },
      _delete_at_path: {
        type: "meeting_delete_at_path_input",
        array: false,
        arrayRequired: false,
        required: false,
      },
      _delete_elem: {
        type: "meeting_delete_elem_input",
        array: false,
        arrayRequired: false,
        required: false,
      },
      _delete_key: {
        type: "meeting_delete_key_input",
        array: false,
        arrayRequired: false,
        required: false,
      },
